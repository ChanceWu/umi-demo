...
const DangerModel: React.FunctionComponent = () => {
  ...
  return (
    <div className={styles.wrap}>
      <TrapezoidButton list={[{ title: '个体危险性评估' }]} desc="单位：人" />
      <DividingLine title="评估等级统计" />
      <StateCircle list={stateList} />
      <div style={{ flex: 1 }}>
        <Bar data={data} color={['#F883B6', 'rgba(253, 129, 176, 0.1)']} />
      </div>
    </div>
  );
};

export default DangerModel;
